...
## [0.7.6](https://github.com/djvcom/djv/compare/v0.7.5...v0.7.6) - 2026-04-24
...
## [0.7.2](https://github.com/djvcom/djv/compare/v0.7.1...v0.7.2) - 2026-04-24
...
## [0.7.1](https://github.com/djvcom/djv/compare/v0.7.0...v0.7.1) - 2026-04-22

### Other

- Update style to better respect screen sizes, handle no db across machines

## [0.7.0](https://github.com/djvcom/djv/compare/v0.6.0...v0.7.0) - 2025-12-31

### Added

- *(nix)* add npm and gitlab sync options to NixOS module

## [0.6.0](https://github.com/djvcom/djv/compare/v0.5.3...v0.6.0) - 2025-12-31

### Added

- *(sync)* add npm, GitLab sync and UI improvements ([#26](https://github.com/djvcom/djv/pull/26))

## [0.5.3](https://github.com/djvcom/djv/compare/v0.5.2...v0.5.3) - 2025-12-26

### Other

- *(nix)* default contributions.user to github.user ([#24](https://github.com/djvcom/djv/pull/24))

## [0.5.2](https://github.com/djvcom/djv/compare/v0.5.1...v0.5.2) - 2025-12-26

### Other

- architecture improvements, database performance, and dark mode ([#22](https://github.com/djvcom/djv/pull/22))
